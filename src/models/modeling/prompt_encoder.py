...
class PromptEncoder(nn.Module):
    def __init__(
        ...
        self.j_prompt_proj.requires_grad_ = True
        self.j_prompt_dropout.requires_grad_ = True
        self.j_prompt_embeddings.requires_grad_ = True
    ...
    def forward(
        ...
        # 1 , 2,  256
        sparse_embeddings = self.j_prompt_dropout(self.j_prompt_proj(self.j_prompt_embeddings).expand(bs, -1, -1))
